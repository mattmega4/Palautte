...
class LandingPageViewController: UIViewController, UITextFieldDelegate {
  ...
  func selectSliderForRGB() {
    
    sliderOne.minimumTrackTintColor = UIColor(red: 255.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
    sliderTwo.minimumTrackTintColor = UIColor(red: 0.0/255.0, green: 255.0/255.0, blue: 0.0/255.0, alpha: 1.0)
    sliderThree.minimumTrackTintColor = UIColor(red: 0.0/255.0, green: 0.0/255.0, blue: 255.0/255.0, alpha: 1.0)
...
//      slider.transform = CGAffineTransform(rotationAngle: CGFloat(-M_PI_2))
    ...
    constraints.append(sliderOne.centerXAnchor.constraint(equalTo: leftHiddenView.centerXAnchor))
    constraints.append(sliderTwo.centerXAnchor.constraint(equalTo: sliderOrWheelContainerView.centerXAnchor))
    constraints.append(sliderThree.centerXAnchor.constraint(equalTo: rightHiddenView.centerXAnchor))
